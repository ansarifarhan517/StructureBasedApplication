...
const apiMappings = {
  ...
  common: {
    ...
    lookup: {
      ...
      getStates: '/LookupApp/lookup/getStates',
      getCountries: '/LookupApp/lookup/getCountries',
    ...
    getServiceType: 'ClientApp/client/getByTypeAndId?type=SERVICETYPE',
    additonalDetailsStructure: '/LoginApp/framework/structure?modelName=ADD_ADDITIONAL_CONTACT&pageName=ADDITIONAL_CONTACT&sectionName=ADD_ADDITIONAL_CONTACT_DETAILS',
  },
  doctor: {
    form: {
      structure:
        '/LoginApp/framework/structure?pageName=DOCTORS&sectionName=ADD_DOCTOR_FORM',
    },
  },
  all_addresses: {
    list: {
      getColumnsList: '/LoginApp/framework/structure',
      getData: '/ClientApp/clientnode/get',
      putStatus: '/ClientApp/clientnode/active',
      updateAddressInline: '/ClientApp/clientnode/udpate/list',
      weekdays: '/ClientApp/client/getByTypeAndId?type=WEEKDAYS',
      locationRestrictions: '/ClientApp/client/getByTypeAndId?type=LOCATIONRESTRICTION',
      getContactDetails: '/ClientApp/clientnode/getcontactdetails',
    },
    map: {
      getColumnsMap: '/LoginApp/framework/structure',
      getOrderCount: '/ClientApp/clientnode/order/count',
      manuallyGeocode: '/ClientApp/clientnode/udpate/addresses',
      fetchAssignedOrders: '/ClientApp/clientnode/assigned/orders/bynodeids',
    },
    form: {
      getFields: '/LoginApp/framework/structure',
      getOrderCount: '/ClientApp/clientnode/order/count',
      manuallyGeocode: '/ClientApp/clientnode/udpate/addresses',
    },
  },
  ...
  shipper: {
    ...
    form: {
      ...
      uploadLogo: '/ClientApp/client/logo/upload',
      getShipperDetails: '/ClientApp/shipper/getbysubclientid',
    },
    properties: {
      priority: '/ClientApp/client/ref?type=PRIORITY',
  ...
  customer: {
    listView: {
      ...
      getLanguageCode: '/ClientApp/whatsApp/template/languages',
      fetchWhatsappTemplate: 'ClientApp/whatsApp/template/details',
    },
  },
  middleMileOrder: {
    listView: {
  ...
  customerNotification: {
    getCustomerNotificationTableStructure: '/LoginApp/framework/structure?modelName=CUSTOMER_NOTIFICATION&pageName=CUSTOMER_NOTIFICATION&sectionName=CUSTOMER_NOTIFICATION_LIST_VIEW',
    ivrPermission: '/ClientApp/client/property?propertyKey=IVRINTEGRATIONACTIVE',
  },
  Saas: {
  ...
  communicationWorkflow: {
    getAllChannels: '/ClientApp/client/getByTypeAndId?type=COMMUNICATION_CHANNEL',
    getConfiguredChannels: '/ClientApp/communication/workflow/get',
    saveConfiguredChannels: '/ClientApp/communication/workflow/save',
  },
}
